							...
							<div class="uofb cf">
								<div class="l_col adrs">
									...
									<form action="test.php" method="post">
										<div class="field">
											<label>Name *</label>
											<input type="text" name="name" palceholder="" class="vl_empty" />
										</div>
										<div class="field">
										...
										<div class="field">
											<label>Street</label>
											<input type="text" name="street" palceholder="" class="vl_empty" />
										</div>
										<div class="field">
											<label>House # </label>
											<input type="text" name="house" palceholder="House Name / Number" />
										</div>
								...
								<div class="r_col">
									...
									<div class="uo_adr_list">
										...
										<?php
										error_reporting(E_ALL & ~E_NOTICE); //Выключаем нотайсы
										...
										//Создаём БД
											$sql = "CREATE DATABASE my_adresses";
										...
										// Сортируем по-алфавиту и выводим на MY ADDRESSES
											$sql = "SELECT theNAME, CITY, AREA, STREET, HOUSE, INFO FROM MyAdresses ORDER BY CITY, AREA, STREET, HOUSE ASC";
											...
											if ($result->num_rows > 0) {
												...
												<div class="item">
													<h3>'.$row["theNAME"].'</h3>
													<p>'.$row["CITY"].','.$row["AREA"].','.$row["STREET"].','.$row["HOUSE"].'<br/> '.$row["INFO"].'</p>
													<div class="actbox">
														<a href="#" class="bcross"></a>
													</div>
												</div>	';
